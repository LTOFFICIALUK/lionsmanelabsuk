  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 lg:py-12 md:py-8 sm:py-6 mb:py-4">
      ...
      <section className="text-center">
        <h1 className="text-4xl font-bold mb-6">About Lion's Mane Labs UK</h1>
        <p className="text-xl text-gray-600">
          Your trusted source for premium Lion's Mane mushroom supplements, bringing the cognitive benefits 
          of this powerful nootropic to modern wellness enthusiasts across the UK.
        </p>
      </section>
      ...
      <section className="bg-white rounded-xl p-8 shadow-lg">
        ...
        <p className="text-gray-600 mb-4">
          At Lion's Mane Labs UK, we're passionate about sharing the natural cognitive benefits of Lion's Mane mushroom 
          with our community. We believe in the power of medicinal mushrooms to enhance modern life, 
          providing improved focus, memory, and mental clarity in our busy world.
        </p>
        <p className="text-gray-600">
          We source only the finest Lion's Mane mushrooms and create supplements that honor both the traditional 
          medicinal use of this powerful fungus and the modern standards of quality and purity that 
        ...
        <div className="bg-white rounded-xl p-8 shadow-lg">
          ...
          <ul className="space-y-4 text-gray-600">
            <li className="flex items-start">
              ...
              Premium Lion's Mane mushroom supplements
            </li>
            <li className="flex items-start">
              <HiSparkles className="text-blue-500 mr-3 mt-1 flex-shrink-0" size={20} />
      ...
      <section className="bg-blue-50 rounded-xl p-8 border border-blue-200">
        ...
        <div className="space-y-4 text-blue-800">
          <p>
            ...
            our commitment to sustainable and ethical sourcing practices. Every batch of Lion's Mane 
            mushrooms is carefully selected for potency, purity, and exceptional quality.
          </p>
          <p>
          ...
          <p>
            ...
            to ensure maximum freshness and potency. Your Lion's Mane experience should be nothing 
      ...
      {/* Why Lion's Mane */}
      <section className="bg-white rounded-xl p-8 shadow-lg">
        <h2 className="text-2xl font-bold mb-4">Why Lion's Mane?</h2>
        <p className="text-gray-600 mb-4">
          Lion's Mane (Hericium erinaceus) has been used for centuries in traditional Chinese and 
          Japanese medicine for its remarkable cognitive benefits. This unique mushroom is known for 
          its ability to support brain health, enhance memory, and improve focus and concentration.
        </p>
        <p className="text-gray-600 mb-4">
          Unlike many synthetic cognitive enhancers, Lion's Mane offers a natural, gentle approach 
          to brain health that has been trusted for generations. Whether taken as capsules, powder, 
          or tea, Lion's Mane provides powerful cognitive support in our demanding modern world.
        </p>
        <p className="text-gray-600">
          We're passionate about bringing this ancient medicinal wisdom to modern wellness 
          enthusiasts, helping people discover the cognitive benefits of Lion's Mane in their 
          daily routines.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              Only the finest Lion's Mane mushrooms make it into our products, ensuring consistent quality and potency.
            </p>
          </div>
          <div className="text-center">
            <div className="flex justify-center mb-3">
      ...
      <section className="text-center bg-gradient-to-r from-blue-500 to-blue-600 
        ...
        <h2 className="text-2xl font-bold mb-4">Ready to Experience Lion's Mane?</h2>
        <p className="text-lg mb-6">
          Discover our premium collection of Lion's Mane supplements and bring ancient wisdom 
          into your modern cognitive enhancement routine.
        </p>
        <Link
          to="/products"
          className="inline-block bg-white text-blue-600 px-8 py-3 rounded-lg
            hover:bg-gray-100 transition-colors font-semibold"
          aria-label="Browse our premium Lion's Mane products"
        >
          Shop Our Products
        </Link>
      </section>
